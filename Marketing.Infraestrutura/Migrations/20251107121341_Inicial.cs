        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataRecusa = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Email = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Token = table.Column<Guid>(type: "char(50)", maxLength: 50, nullable: false, collation: "ascii_general_ci"),
                    UltimaCompetenciaEnviada = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPedidos = table.Column<int>(type: "int", nullable: false),
                    PedidosComCocaCola = table.Column<int>(type: "int", nullable: false),
                    IncidenciaReal = table.Column<decimal>(type: "NUMERIC(8,4)", precision: 8, scale: 4, nullable: false),
                    Meta = table.Column<decimal>(type: "NUMERIC(18,4)", precision: 18, scale: 4, nullable: false),
                    PrecoUnitarioMedio = table.Column<decimal>(type: "NUMERIC(8,2)", precision: 8, scale: 2, nullable: false),
                    TotalPedidosNaoCapturados = table.Column<int>(type: "int", nullable: false),
                    ReceitaNaoCapturada = table.Column<decimal>(type: "NUMERIC(8,2)", precision: 8, scale: 2, nullable: false),
                    CorVerdeGrafico = table.Column<decimal>(type: "NUMERIC(8,2)", precision: 8, scale: 2, nullable: false),
                    CorTransparenteGrafico = table.Column<decimal>(type: "NUMERIC(8,2)", precision: 8, scale: 2, nullable: false),
                    CorVermelhaGrafico = table.Column<decimal>(type: "NUMERIC(8,2)", precision: 8, scale: 2, nullable: false)
                },
                constraints: table =>
                {
