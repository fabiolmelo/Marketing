    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Estabelecimentos", x => new { x.Cnpj, x.RedeNome });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContatoTelefone = table.Column<string>(type: "TEXT", nullable: false),
                    EstabelecimentoCnpj = table.Column<string>(type: "TEXT", nullable: false),
                    EstabelecimentoRedeNome = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContatoEstabelecimento", x => new { x.ContatoTelefone, x.EstabelecimentoCnpj, x.EstabelecimentoRedeNome });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContatoEstabelecimento_Estabelecimentos_EstabelecimentoCnpj_EstabelecimentoRedeNome",
                        columns: x => new { x.EstabelecimentoCnpj, x.EstabelecimentoRedeNome },
                        principalTable: "Estabelecimentos",
                        principalColumns: new[] { "Cnpj", "RedeNome" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtratosVendas", x => new { x.Competencia, x.EstabelecimentoCnpj, x.EstabelecimentoRedeNome });
                    table.ForeignKey(
                        name: "FK_ExtratosVendas_Estabelecimentos_EstabelecimentoCnpj_EstabelecimentoRedeNome",
                        columns: x => new { x.EstabelecimentoCnpj, x.EstabelecimentoRedeNome },
                        principalTable: "Estabelecimentos",
                        principalColumns: new[] { "Cnpj", "RedeNome" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContatoEstabelecimento_EstabelecimentoCnpj_EstabelecimentoRedeNome",
                table: "ContatoEstabelecimento",
                columns: new[] { "EstabelecimentoCnpj", "EstabelecimentoRedeNome" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtratosVendas_EstabelecimentoCnpj_EstabelecimentoRedeNome",
